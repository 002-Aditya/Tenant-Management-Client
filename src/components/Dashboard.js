                        ...
                        <CardContent>
                            {revenueData && (
                                <div className="space-y-6">
                                    ...
                                    {/* Improved Bar Chart - Hidden on mobile */}
                                    <div className="hidden sm:block bg-gray-50 p-4 rounded-lg">
                                        <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 h-64 relative">
                                            {revenueData.months.map((month, index) => {
                                                const maxRevenue = Math.max(...revenueData.revenue, 1); // Avoid division by zero
                                                const height = revenueData.revenue[index] ? (revenueData.revenue[index] / maxRevenue) * 100 : 0;
                                                return (
